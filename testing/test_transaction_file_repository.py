"""
Test cases for transaction_file_repository module
"""
import os
import unittest
...
class TestCaseTransactionFileRepository(unittest.TestCase):
    def setUp(self):
        ...
        self.__tr_repo = TransactionFileRepository("test_transactions.txt", self.__film_repo, self.__cl_repo)
